...
var $author$project$Types$CastleGuardPatrol = function (a) {
	return {$: 'CastleGuardPatrol', a: a};
};
...
var $author$project$BehaviorEngine$UnitStates$DefendTerritory = {$: 'DefendTerritory'};
var $author$project$BehaviorEngine$UnitStates$initCastleGuardPatrolState = {currentOperational: $elm$core$Maybe$Nothing, currentStrategic: $author$project$BehaviorEngine$UnitStates$DefendTerritory, currentTactical: $elm$core$Maybe$Nothing, engagedTarget: $elm$core$Maybe$Nothing, interruptState: $elm$core$Maybe$Nothing, patrolIndex: 0, patrolRoute: _List_Nil, perimeterIndex: 0, perimeterPoints: _List_Nil};
...
var $author$project$GameHelpers$createHenchman = F4(
	function (unitType, unitId, buildingId, homeBuilding) {
		var initialBehavior = _Utils_eq(unitType, $author$project$GameStrings$unitTypeCastleGuard) ? $author$project$Types$CastleGuardPatrol($author$project$BehaviorEngine$UnitStates$initCastleGuardPatrolState) : $author$project$Types$Sleeping;
		var _v0 = _Utils_eq(unitType, $author$project$GameStrings$unitTypeTaxCollector) ? _Utils_Tuple3(
			50,
			1.5,
			_List_fromArray(
...
var $author$project$BehaviorEngine$Actions$executeAttackMonster = F2(
	function (context, monsterId) {
...
var $author$project$BehaviorEngine$Types$PerimeterCalculated = function (a) {
	return {$: 'PerimeterCalculated', a: a};
};
var $author$project$BehaviorEngine$Actions$executeCalculateBuildingPerimeter = F2(
	function (context, buildingId) {
		...
		if (maybeBuilding.$ === 'Nothing') {
			...
			var centerX = (building.gridX * buildGridSize) + ((($author$project$Types$buildingSizeToGridCells(building.size) * buildGridSize) / 2) | 0);
			var centerY = (building.gridY * buildGridSize) + ((($author$project$Types$buildingSizeToGridCells(building.size) * buildGridSize) / 2) | 0);
			var radius = ((($author$project$Types$buildingSizeToGridCells(building.size) * buildGridSize) / 2) | 0) + 48;
			var waypoints = _List_fromArray(
				[
					_Utils_Tuple2(centerX, centerY - radius),
					_Utils_Tuple2(
					centerX + $elm$core$Basics$round(radius * 0.7),
					centerY - $elm$core$Basics$round(radius * 0.7)),
					_Utils_Tuple2(centerX + radius, centerY),
					_Utils_Tuple2(
					centerX + $elm$core$Basics$round(radius * 0.7),
					centerY + $elm$core$Basics$round(radius * 0.7)),
					_Utils_Tuple2(centerX, centerY + radius),
			...
			return _Utils_Tuple3(
				context.unit,
				$author$project$BehaviorEngine$Types$PerimeterCalculated(waypoints),
				false);
		}
	});
...
var $author$project$BehaviorEngine$Actions$executeCheckCircleComplete = function (context) {
	return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoResult, false);
};
var $author$project$BehaviorEngine$Actions$executeCheckMonsterDefeated = F2(
	function (context, monsterId) {
		return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoResult, false);
	});
var $author$project$BehaviorEngine$Actions$executeCheckPatrolState = function (context) {
	return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoResult, false);
};
var $author$project$BehaviorEngine$Actions$executeCirclePerimeter = function (context) {
	return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoResult, false);
};
...
var $author$project$BehaviorEngine$Actions$executeGetCurrentPatrolTarget = function (context) {
	return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoResult, false);
};
var $author$project$BehaviorEngine$Actions$executeIncrementPatrolIndex = function (context) {
	return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$Success, false);
};
var $author$project$BehaviorEngine$Types$NoUnitFound = {$: 'NoUnitFound'};
var $author$project$BehaviorEngine$Actions$executeMoveToMonster = F2(
	function (context, monsterId) {
		return _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoUnitFound, false);
	});
...
var $author$project$BehaviorEngine$Types$PatrolRouteCreated = function (a) {
	return {$: 'PatrolRouteCreated', a: a};
};
var $author$project$BehaviorEngine$Actions$executeSelectPatrolBuildings = function (context) {
	var _v0 = context.unit.location;
	if (_v0.$ === 'OnMap') {
		var x = _v0.a;
		var y = _v0.b;
		var availableBuildings = A2(
			$elm$core$List$filter,
			function (b) {
				return _Utils_eq(b.owner, $author$project$Types$Player);
			},
			context.buildings);
		var prioritizedBuildings = A2(
			$elm$core$List$map,
			$elm$core$Tuple$first,
			A2(
				$elm$core$List$sortBy,
				...
				A2(
					$elm$core$List$map,
					function (b) {
						var isDamaged = _Utils_cmp(b.hp, b.maxHp) < 0;
						var buildGridSize = 64;
						var bx = (b.gridX * buildGridSize) + (($author$project$Types$buildingSizeToGridCells(b.size) * buildGridSize) / 2);
						var by = (b.gridY * buildGridSize) + (($author$project$Types$buildingSizeToGridCells(b.size) * buildGridSize) / 2);
						var dist = $elm$core$Basics$sqrt(
							A2($elm$core$Basics$pow, x - bx, 2) + A2($elm$core$Basics$pow, y - by, 2));
						var priority = isDamaged ? ((-1000) + dist) : dist;
						return _Utils_Tuple2(b, priority);
					},
					availableBuildings)));
		var selectedBuildings = A2(
			$elm$core$List$map,
			function ($) {
				return $.id;
			},
			A2($elm$core$List$take, 3, prioritizedBuildings));
		return $elm$core$List$isEmpty(selectedBuildings) ? _Utils_Tuple3(context.unit, $author$project$BehaviorEngine$Types$NoBuildingFound, false) : _Utils_Tuple3(
			context.unit,
			$author$project$BehaviorEngine$Types$PatrolRouteCreated(selectedBuildings),
			false);
	} else {
		return _Utils_Tuple3(
			context.unit,
			$author$project$BehaviorEngine$Types$Failure('Cannot select patrol while garrisoned'),
			false);
	}
};
...
var $author$project$BehaviorEngine$Actions$executeOperationalAction = F2(
	function (context, action) {
		switch (action.$) {
			...
			case 'SelectPatrolBuildings':
				return $author$project$BehaviorEngine$Actions$executeSelectPatrolBuildings(context);
			case 'GetCurrentPatrolTarget':
				return $author$project$BehaviorEngine$Actions$executeGetCurrentPatrolTarget(context);
			case 'CalculateBuildingPerimeter':
				var buildingId = action.a;
				return A2($author$project$BehaviorEngine$Actions$executeCalculateBuildingPerimeter, context, buildingId);
			case 'CirclePerimeter':
				return $author$project$BehaviorEngine$Actions$executeCirclePerimeter(context);
			case 'IncrementPatrolIndex':
				return $author$project$BehaviorEngine$Actions$executeIncrementPatrolIndex(context);
			case 'CheckCircleComplete':
				return $author$project$BehaviorEngine$Actions$executeCheckCircleComplete(context);
			case 'CheckPatrolState':
				return $author$project$BehaviorEngine$Actions$executeCheckPatrolState(context);
			case 'MoveToMonster':
				var monsterId = action.a;
				return A2($author$project$BehaviorEngine$Actions$executeMoveToMonster, context, monsterId);
			case 'AttackMonster':
				var monsterId = action.a;
				return A2($author$project$BehaviorEngine$Actions$executeAttackMonster, context, monsterId);
			default:
				var monsterId = action.a;
				return A2($author$project$BehaviorEngine$Actions$executeCheckMonsterDefeated, context, monsterId);
		}
	});
var $author$project$BehaviorEngine$UnitStates$EngageMonster = {$: 'EngageMonster'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$checkWatchForMonsters = function (context) {
	return false;
};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$checkActiveAwarenessCastleGuardPatrol = F2(
	function (context, state) {
		return $author$project$BehaviorEngine$Units$CastleGuardPatrol$checkWatchForMonsters(context) ? $elm$core$Maybe$Just(
			{awarenessType: 'WatchForMonsters', forcedTactical: $author$project$BehaviorEngine$UnitStates$EngageMonster, priorityLevel: 5}) : $elm$core$Maybe$Nothing;
	});
var $author$project$BehaviorEngine$UnitStates$PatrolRoute = {$: 'PatrolRoute'};
var $author$project$BehaviorEngine$UnitStates$PlanPatrolRoute = {$: 'PlanPatrolRoute'};
var $author$project$BehaviorEngine$UnitStates$RestInGarrison = {$: 'RestInGarrison'};
var $author$project$BehaviorEngine$UnitStates$CirclePerimeter = {$: 'CirclePerimeter'};
var $author$project$BehaviorEngine$UnitStates$ResumePatrol = {$: 'ResumePatrol'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalAttackMonster = F2(
	function (context, state) {
		return _Utils_Tuple3(
			context.unit,
			_Utils_update(
				state,
				{
					...
					currentTactical: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$ResumePatrol)
				}),
			false);
	});
var $author$project$BehaviorEngine$UnitStates$IncrementPatrolIndex = {$: 'IncrementPatrolIndex'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCheckCircleComplete = F2(
	function (context, state) {
		return _Utils_Tuple3(
			context.unit,
			_Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$IncrementPatrolIndex),
					perimeterIndex: 0,
					perimeterPoints: _List_Nil
				}),
			false);
	});
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCheckMonsterDefeated = F2(
	function (context, state) {
		return _Utils_Tuple3(
			context.unit,
			_Utils_update(
...
var $author$project$BehaviorEngine$UnitStates$CheckCircleComplete = {$: 'CheckCircleComplete'};
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCirclePerimeter = F2(
	function (context, state) {
		var _v0 = $elm$core$List$head(
			A2($elm$core$List$drop, state.patrolIndex, state.patrolRoute));
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple3(
				context.unit,
				_Utils_update(
					state,
					{
						currentOperational: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$CheckCircleComplete)
					}),
				false);
		} else {
			var buildingId = _v0.a;
			var _v1 = $elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (b) {
			...
			if (_v1.$ === 'Nothing') {
				...
				var building = _v1.a;
				var _v2 = context.unit.targetDestination;
				if (_v2.$ === 'Nothing') {
					var unit = context.unit;
					var sizeCells = $author$project$Types$buildingSizeToGridCells(building.size);
					var pathGridSize = 32;
					var buildGridSize = 64;
					var buildingCenterX = (building.gridX * buildGridSize) + ((sizeCells * buildGridSize) / 2);
					var buildingCenterY = (building.gridY * buildGridSize) + ((sizeCells * buildGridSize) / 2);
					var buildingRadius = (sizeCells * buildGridSize) / 2;
					var distance = buildingRadius + 64;
					var angle = ((state.perimeterIndex * 73) + (context.unit.id * 137)) * 0.1;
					var targetWorldX = buildingCenterX + (distance * $elm$core$Basics$cos(angle));
					var targetCellX = $elm$core$Basics$floor(targetWorldX / pathGridSize);
					var targetWorldY = buildingCenterY + (distance * $elm$core$Basics$sin(angle));
					var targetCellY = $elm$core$Basics$floor(targetWorldY / pathGridSize);
					var updatedUnit = _Utils_update(
						unit,
						{
							targetDestination: $elm$core$Maybe$Just(
					...
					var _v3 = A2(
						$elm$core$Debug$log,
						'[CG] CirclePerimeter new waypoint',
						{
							buildingId: buildingId,
							targetCell: _Utils_Tuple2(targetCellX, targetCellY),
							waypointIndex: state.perimeterIndex
						});
					return _Utils_Tuple3(updatedUnit, state, true);
				} else {
					var _v4 = A2($author$project$BehaviorEngine$Actions$executeOperationalAction, context, $author$project$BehaviorEngine$Types$CheckArrival);
					var updatedUnit = _v4.a;
					var result = _v4.b;
					if (result.$ === 'Arrived') {
						...
						return circleComplete ? _Utils_Tuple3(
							_Utils_update(
								updatedUnit,
								{targetDestination: $elm$core$Maybe$Nothing}),
							_Utils_update(
							...
							_Utils_update(
								state,
								{perimeterIndex: newIndex}),
							false);
					} else {
						return _Utils_Tuple3(
							updatedUnit,
							state,
							$elm$core$List$isEmpty(updatedUnit.path));
					}
				}
			}
		}
	});
var $author$project$BehaviorEngine$UnitStates$WithoutHome = {$: 'WithoutHome'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalEnterGarrison = F2(
	function (context, state) {
		var _v0 = A2($author$project$BehaviorEngine$Actions$executeOperationalAction, context, $author$project$BehaviorEngine$Types$EnterGarrison);
		var updatedUnit = _v0.a;
		var result = _v0.b;
		var needsPath = _v0.c;
		switch (result.$) {
			case 'Success':
				return _Utils_Tuple3(
					...
					_Utils_update(
						...
						{
							currentOperational: $elm$core$Maybe$Nothing,
							currentTactical: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$RestInGarrison)
						}),
					false);
			case 'HomeDestroyed':
				return _Utils_Tuple3(
					...
					_Utils_update(
						state,
						{currentOperational: $elm$core$Maybe$Nothing, currentStrategic: $author$project$BehaviorEngine$UnitStates$WithoutHome, currentTactical: $elm$core$Maybe$Nothing}),
					false);
			case 'NotArrived':
				return _Utils_Tuple3(updatedUnit, state, true);
			default:
				return _Utils_Tuple3(updatedUnit, state, needsPath);
		}
	});
var $author$project$BehaviorEngine$Types$ExitGarrison = {$: 'ExitGarrison'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalExitGarrison = F2(
	function (context, state) {
		var _v0 = context.unit.homeBuilding;
		if (_v0.$ === 'Just') {
			var homeBuildingId = _v0.a;
			...
			if (_v1.$ === 'Just') {
				var homeBuilding = _v1.a;
				var _v2 = A2($author$project$BehaviorEngine$Actions$executeOperationalAction, context, $author$project$BehaviorEngine$Types$ExitGarrison);
				var updatedUnit = _v2.a;
				var result = _v2.b;
				var needsPath = _v2.c;
				if (result.$ === 'Success') {
					return _Utils_Tuple3(
						...
						_Utils_update(
							...
							{
								currentOperational: $elm$core$Maybe$Nothing,
								currentTactical: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$PlanPatrolRoute)
							}),
						false);
				} else {
					return _Utils_Tuple3(updatedUnit, state, needsPath);
...
var $author$project$BehaviorEngine$UnitStates$MoveToBuilding = {$: 'MoveToBuilding'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalFindCastle = F2(
	function (context, state) {
		var _v0 = context.unit.homeBuilding;
		if (_v0.$ === 'Just') {
			var homeBuildingId = _v0.a;
			...
			if (_v1.$ === 'Just') {
				...
				var unit = context.unit;
				var buildGridSize = 64;
				var _v2 = $author$project$Grid$getBuildingEntrance(castle);
				var entranceGridX = _v2.a;
				var entranceGridY = _v2.b;
				var targetWorldX = (entranceGridX * buildGridSize) + (buildGridSize / 2);
				var targetCellX = $elm$core$Basics$floor(targetWorldX / 32);
				var targetWorldY = ((entranceGridY + 1) * buildGridSize) + (buildGridSize / 2);
				var targetCellY = $elm$core$Basics$floor(targetWorldY / 32);
				var updatedUnit = _Utils_update(
					unit,
					{
						targetDestination: $elm$core$Maybe$Just(
				...
				var _v3 = A2(
					$elm$core$Debug$log,
					'[CG] SetTarget (return home)',
					{
						castleId: castle.id,
						entrance: _Utils_Tuple2(entranceGridX, entranceGridY),
						needsPath: true,
						targetCell: _Utils_Tuple2(targetCellX, targetCellY)
					});
				return _Utils_Tuple3(
					...
					_Utils_update(
						state,
						{
							currentOperational: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$MoveToBuilding)
						}),
					true);
			} else {
				return _Utils_Tuple3(
...
var $author$project$BehaviorEngine$UnitStates$ReturnToCastle = {$: 'ReturnToCastle'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalGetCurrentPatrolTarget = F2(
	function (context, state) {
		var _v0 = A2(
			$elm$core$Debug$log,
			'[CG] GetCurrentPatrolTarget',
			{
				patrolIndex: state.patrolIndex,
				routeLength: $elm$core$List$length(state.patrolRoute)
			});
		var _v1 = $elm$core$List$head(
			A2($elm$core$List$drop, state.patrolIndex, state.patrolRoute));
		if (_v1.$ === 'Just') {
			var buildingId = _v1.a;
			...
			if (_v2.$ === 'Just') {
				...
				var _v3 = function () {
					...
					if (_v4.$ === 'OnMap') {
						...
						return _Utils_Tuple2(buildingCenterX, buildingCenterY);
					}
				}();
				var unitX = _v3.a;
				var unitY = _v3.b;
				...
				var dy = unitY - buildingCenterY;
				var distance = $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
				var normalizedDx = (distance > 0) ? (dx / distance) : 1;
				var targetWorldX = buildingCenterX - (normalizedDx * (buildingRadius + 48));
				var targetCellX = $elm$core$Basics$floor(targetWorldX / pathGridSize);
				var normalizedDy = (distance > 0) ? (dy / distance) : 0;
				var targetWorldY = buildingCenterY - (normalizedDy * (buildingRadius + 48));
				var targetCellY = $elm$core$Basics$floor(targetWorldY / pathGridSize);
				var updatedUnit = _Utils_update(
					unit,
					{
				...
				var _v5 = A2(
					...
					'[CG] SetTarget (patrol)',
					{
						buildingCenter: _Utils_Tuple2(
							$elm$core$Basics$floor(buildingCenterX / pathGridSize),
							$elm$core$Basics$floor(buildingCenterY / pathGridSize)),
						buildingId: buildingId,
						needsPath: true,
						targetCell: _Utils_Tuple2(targetCellX, targetCellY),
						unitPos: _Utils_Tuple2(
							$elm$core$Basics$floor(unitX / pathGridSize),
							$elm$core$Basics$floor(unitY / pathGridSize))
					});
				return _Utils_Tuple3(
					updatedUnit,
					_Utils_update(
				...
				var newRoute = _Utils_ap(
					A2($elm$core$List$take, state.patrolIndex, state.patrolRoute),
					A2($elm$core$List$drop, state.patrolIndex + 1, state.patrolRoute));
				return _Utils_Tuple3(
					context.unit,
					_Utils_update(
						state,
			...
			return _Utils_Tuple3(
				...
				_Utils_update(
					...
					{
						currentOperational: $elm$core$Maybe$Nothing,
						currentTactical: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$ReturnToCastle)
					}),
				false);
		}
	});
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalIncrementPatrolIndex = F2(
	function (context, state) {
		var newIndex = state.patrolIndex + 1;
		return (_Utils_cmp(
			newIndex,
			$elm$core$List$length(state.patrolRoute)) > -1) ? _Utils_Tuple3(
			context.unit,
			_Utils_update(
				state,
				{
			...
			_Utils_update(
				...
				{
					currentOperational: $elm$core$Maybe$Nothing,
					currentTactical: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$PatrolRoute),
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalMoveToMonster = F2(
	function (context, state) {
		return _Utils_Tuple3(
			context.unit,
			_Utils_update(
...
var $author$project$BehaviorEngine$Types$SelectPatrolBuildings = {$: 'SelectPatrolBuildings'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalSelectPatrolBuildings = F2(
	function (context, state) {
		var _v0 = A2($author$project$BehaviorEngine$Actions$executeOperationalAction, context, $author$project$BehaviorEngine$Types$SelectPatrolBuildings);
		var updatedUnit = _v0.a;
		var result = _v0.b;
		var needsPath = _v0.c;
		var _v1 = A2(
			$elm$core$Debug$log,
			'[CG] SelectPatrolBuildings',
			{needsPath: needsPath, result: result});
		switch (result.$) {
			case 'PatrolRouteCreated':
				var buildingIds = result.a;
				var _v3 = A2(
					$elm$core$Debug$log,
					'[CG] PatrolRouteCreated',
					{
						buildingIds: buildingIds,
						count: $elm$core$List$length(buildingIds)
					});
				return _Utils_Tuple3(
					updatedUnit,
					_Utils_update(
			...
			case 'NoBuildingFound':
				var _v4 = A2($elm$core$Debug$log, '[CG] NoBuildingFound', 'Returning to castle');
				return _Utils_Tuple3(
					updatedUnit,
					_Utils_update(
						state,
...
var $author$project$BehaviorEngine$UnitStates$ExitGarrison = {$: 'ExitGarrison'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalSleep = F2(
	function (context, state) {
		var _v0 = A2($author$project$BehaviorEngine$Actions$executeOperationalAction, context, $author$project$BehaviorEngine$Types$Sleep);
		var updatedUnit = _v0.a;
		var result = _v0.b;
		var needsPath = _v0.c;
		...
		return ((newTimer >= 1.0) || (_Utils_cmp(updatedUnit.hp, updatedUnit.maxHp) > -1)) ? _Utils_Tuple3(
			...
			_Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just($author$project$BehaviorEngine$UnitStates$ExitGarrison)
				}),
			false) : _Utils_Tuple3(
			_Utils_update(
				updatedUnit,
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$executeOperationalCastleGuardPatrol = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple3(context.unit, state, false);
		} else {
			switch (_v0.a.$) {
				case 'Sleep':
					var _v1 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalSleep, context, state);
				case 'SelectPatrolBuildings':
					var _v2 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalSelectPatrolBuildings, context, state);
				case 'GetCurrentPatrolTarget':
					var _v3 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalGetCurrentPatrolTarget, context, state);
				case 'MoveToBuilding':
					var _v4 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalMoveToBuilding, context, state);
				case 'CirclePerimeter':
					var _v5 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCirclePerimeter, context, state);
				case 'IncrementPatrolIndex':
					var _v6 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalIncrementPatrolIndex, context, state);
				case 'CheckCircleComplete':
					var _v7 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCheckCircleComplete, context, state);
				case 'FindCastle':
					var _v8 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalFindCastle, context, state);
				case 'MoveToMonster':
					var _v9 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalMoveToMonster, context, state);
				case 'AttackMonster':
					var _v10 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalAttackMonster, context, state);
				case 'CheckMonsterDefeated':
					var _v11 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalCheckMonsterDefeated, context, state);
				case 'ExitGarrison':
					var _v12 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalExitGarrison, context, state);
				case 'EnterGarrison':
					var _v13 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleOperationalEnterGarrison, context, state);
				default:
					var _v14 = _v0.a;
					return _Utils_Tuple3(context.unit, state, false);
			}
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalCircleBuilding = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$CirclePerimeter;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
				});
			return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeOperationalCastleGuardPatrol, context, newState);
		} else {
			var operational = _v0.a;
			return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeOperationalCastleGuardPatrol, context, state);
		}
	});
var $author$project$BehaviorEngine$UnitStates$MoveToMonster = {$: 'MoveToMonster'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalEngageMonster = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$MoveToMonster;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
...
var $author$project$BehaviorEngine$UnitStates$GetCurrentPatrolTarget = {$: 'GetCurrentPatrolTarget'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalPatrolRoute = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$GetCurrentPatrolTarget;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
...
var $author$project$BehaviorEngine$UnitStates$SelectPatrolBuildings = {$: 'SelectPatrolBuildings'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalPlanPatrolRoute = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$SelectPatrolBuildings;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
...
var $author$project$BehaviorEngine$UnitStates$Sleep = {$: 'Sleep'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalRestInGarrison = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$Sleep;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalResumePatrol = F2(
	function (context, state) {
		return $elm$core$List$isEmpty(state.patrolRoute) ? _Utils_Tuple3(
			context.unit,
			_Utils_update(
				state,
				{
...
var $author$project$BehaviorEngine$UnitStates$FindCastle = {$: 'FindCastle'};
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalReturnToCastle = F2(
	function (context, state) {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			var firstOp = $author$project$BehaviorEngine$UnitStates$FindCastle;
			var newState = _Utils_update(
				state,
				{
					currentOperational: $elm$core$Maybe$Just(firstOp)
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$executeTacticalCastleGuardPatrol = F2(
	function (context, state) {
		var _v0 = state.currentTactical;
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple3(context.unit, state, false);
		} else {
			switch (_v0.a.$) {
				case 'RestInGarrison':
					var _v1 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalRestInGarrison, context, state);
				case 'PlanPatrolRoute':
					var _v2 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalPlanPatrolRoute, context, state);
				case 'PatrolRoute':
					var _v3 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalPatrolRoute, context, state);
				case 'CircleBuilding':
					var _v4 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalCircleBuilding, context, state);
				case 'EngageMonster':
					var _v5 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalEngageMonster, context, state);
				case 'ResumePatrol':
					var _v6 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalResumePatrol, context, state);
				case 'ReturnToCastle':
					var _v7 = _v0.a;
					return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleTacticalReturnToCastle, context, state);
				default:
					var _v8 = _v0.a;
					return _Utils_Tuple3(context.unit, state, false);
			}
...
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleStrategicDefendTerritory = F2(
	function (context, state) {
		var _v0 = state.currentTactical;
		if (_v0.$ === 'Nothing') {
			var initialTactical = function () {
				var _v1 = context.unit.location;
				if (_v1.$ === 'Garrisoned') {
					return $author$project$BehaviorEngine$UnitStates$RestInGarrison;
				} else {
					return $elm$core$List$isEmpty(state.patrolRoute) ? $author$project$BehaviorEngine$UnitStates$PlanPatrolRoute : $author$project$BehaviorEngine$UnitStates$PatrolRoute;
				}
			}();
			var newState = _Utils_update(
				state,
				{
					currentTactical: $elm$core$Maybe$Just(initialTactical)
				});
			return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeTacticalCastleGuardPatrol, context, newState);
		} else {
			var tactical = _v0.a;
			return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeTacticalCastleGuardPatrol, context, state);
		}
	});
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$executeStrategicCastleGuardPatrol = F2(
	function (context, state) {
		var _v0 = state.currentStrategic;
		if (_v0.$ === 'DefendTerritory') {
			return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleStrategicDefendTerritory, context, state);
		} else {
			return _Utils_Tuple3(context.unit, state, false);
		}
	});
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$handleInterruptCastleGuardPatrol = F2(
	function (state, trigger) {
		var interruptState = function () {
			var _v0 = state.currentTactical;
			if (_v0.$ === 'Just') {
				var tactical = _v0.a;
				return $elm$core$Maybe$Just(
					{previousOperationalIndex: 0, previousTactical: tactical});
			} else {
				return $elm$core$Maybe$Nothing;
			}
		}();
		var newState = _Utils_update(
			...
			{
				currentOperational: $elm$core$Maybe$Nothing,
				currentTactical: $elm$core$Maybe$Just(trigger.forcedTactical),
				interruptState: interruptState
			});
		return _Utils_Tuple2(newState, true);
	});
var $author$project$BehaviorEngine$Units$CastleGuardPatrol$updateCastleGuardPatrol = F2(
	function (context, state) {
		var activeAwareness = A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$checkActiveAwarenessCastleGuardPatrol, context, state);
		var _v0 = function () {
			if (activeAwareness.$ === 'Just') {
				var trigger = activeAwareness.a;
				return A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$handleInterruptCastleGuardPatrol, state, trigger);
			} else {
				return _Utils_Tuple2(state, false);
			}
		}();
		var interruptedState = _v0.a;
		var wasInterrupted = _v0.b;
		var _v2 = wasInterrupted ? A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeStrategicCastleGuardPatrol, context, interruptedState) : A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$executeStrategicCastleGuardPatrol, context, state);
		var updatedUnit = _v2.a;
		var updatedState = _v2.b;
		var needsPath = _v2.c;
		return _Utils_Tuple3(updatedUnit, updatedState, needsPath);
	});
var $author$project$BehaviorEngine$Interpreter$executeNormalBehavior = function (context) {
	...
	switch (_v0.$) {
		...
		case 'DeliveringGold':
			return _Utils_Tuple2(context.unit, false);
		default:
			var guardState = _v0.a;
			var _v14 = A2($author$project$BehaviorEngine$Units$CastleGuardPatrol$updateCastleGuardPatrol, context, guardState);
			var updatedUnit = _v14.a;
			var updatedState = _v14.b;
			var needsPath = _v14.c;
			return _Utils_Tuple2(
				_Utils_update(
					updatedUnit,
					{
						behavior: $author$project$Types$CastleGuardPatrol(updatedState)
					}),
				needsPath);
	}
};
					...
					if (A2($elm$core$List$member, unit.id, unitIdsNeedingPaths)) {
						...
						if ((_v22.a.$ === 'OnMap') && (_v22.b.$ === 'Just')) {
							...
							var _v24 = A2(
								...
								{
									from: _Utils_Tuple2(
										$elm$core$Basics$floor(x / 32),
										$elm$core$Basics$floor(y / 32)),
									pathEmpty: $elm$core$List$isEmpty(newPath),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							_Utils_eq(unit.unitType, $author$project$GameStrings$unitTypeTaxCollector) ? $author$project$GameStrings$unitIconTaxCollector : (_Utils_eq(unit.unitType, $author$project$GameStrings$unitTypeCastleGuard) ? $author$project$GameStrings$unitIconCastleGuard : $author$project$GameStrings$unitIconUnknown))
						])),
					isSelected ? A2(
					$elm$html$Html$div,
					_List_fromArray(
...
var $author$project$View$SelectionPanel$formatCastleGuardBehavior = function (state) {
	var tacticalStr = function () {
		var _v16 = state.currentTactical;
		if (_v16.$ === 'Nothing') {
			return 'None';
		} else {
			switch (_v16.a.$) {
				...
				case 'CircleBuilding':
					var _v20 = _v16.a;
					return 'Circle Building';
				case 'EngageMonster':
					var _v21 = _v16.a;
					return 'Engage Monster';
				case 'ResumePatrol':
					var _v22 = _v16.a;
					return 'Resume Patrol';
				case 'ReturnToCastle':
					var _v23 = _v16.a;
					return 'Return to Castle';
				default:
					var _v24 = _v16.a;
					return 'Idle';
			}
	...
	var strategicStr = function () {
		var _v15 = state.currentStrategic;
		if (_v15.$ === 'DefendTerritory') {
			return 'Defend Territory';
		} else {
			return 'Without Home';
		}
	}();
	var patrolInfo = $elm$core$List$isEmpty(state.patrolRoute) ? '' : (' [' + ($elm$core$String$fromInt(state.patrolIndex + 1) + ('/' + ($elm$core$String$fromInt(
		$elm$core$List$length(state.patrolRoute)) + ']'))));
	var operationalStr = function () {
		var _v0 = state.currentOperational;
		if (_v0.$ === 'Nothing') {
			return 'None';
		} else {
			switch (_v0.a.$) {
				...
				case 'CheckCircleComplete':
					var _v7 = _v0.a;
					return 'Checking Circle';
				case 'FindCastle':
					var _v8 = _v0.a;
					return 'Finding Castle';
				case 'MoveToMonster':
					var _v9 = _v0.a;
					return 'Moving to Monster';
				case 'AttackMonster':
					var _v10 = _v0.a;
					return 'Attacking';
				case 'CheckMonsterDefeated':
					var _v11 = _v0.a;
					return 'Checking Monster';
				case 'ExitGarrison':
					var _v12 = _v0.a;
					return 'Exiting Garrison';
				case 'EnterGarrison':
					var _v13 = _v0.a;
					return 'Entering Garrison';
				default:
					var _v14 = _v0.a;
					return 'Idle';
			}
	...
	return strategicStr + (' > ' + (tacticalStr + (' > ' + (operationalStr + patrolInfo))));
};
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											unit.unitType + (' #' + $elm$core$String$fromInt(unit.id)))
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
														...
														return A3(
															...
															'behavior-' + function () {
																...
																switch (_v16.$) {
																	...
																	default:
																		var state = _v16.a;
																		return $author$project$View$SelectionPanel$formatCastleGuardBehavior(state);
																}
															}(),
															x,
															y);
